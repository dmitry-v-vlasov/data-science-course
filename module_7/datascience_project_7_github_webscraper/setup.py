...
if __name__ == "__main__":
    ...
    setuptools.setup(
        ...
        license="MIT",
        url="https://github.com/dmitry-v-vlasov/data-science-course/tree/master/module_7/datascience_project_7_github_webscraper",
        ...
        install_requires=["setuptools", "wheel", "numpy", "pandas", "requests", "requests-ip-rotator", "lxml", "pytest"],
